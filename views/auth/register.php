            ...
            <div class="row g-0">
                <div class="col-md-5 bg-primary text-white d-flex flex-column justify-content-center align-items-center p-4" style="border-radius: 0.25rem 0 0 0.25rem;">
                    <div class="text-center py-5">
                        ...
                        <p class="mt-4">Crea una cuenta para comenzar a gestionar tus cursos educativos.</p>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="card-body p-5">
                        <h2 class="card-title text-center mb-4 fw-bold text-primary">Registro de Usuario</h2>
                        ...
                        <form action="index.php?route=auth" method="post">
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0" id="username" name="username" placeholder="Nombre de Usuario" required>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <p class="mb-0">¿Ya tienes una cuenta?
                                    <a href="index.php?route=login" class="text-primary fw-bold">Inicia sesión aquí</a>
                                </p>
                            </div>
                        </form>
                    </div>
